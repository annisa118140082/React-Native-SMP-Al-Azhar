      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.isi}>
            ...
            Nama{"\t"}
            {"\t"}
            {"\t"}SMPS AL - AZHAR 3 BANDAR LAMPUNG{"\n"}
            {"\n"}
            Akreditasi{"\t"}
            {"\t"}Akreditasi A{"\n"}
            {"\n"}
            Alamat{"\t"}
            {"\t"}
            {"\t"}JL. Gunung Tanggamus Raya No.34{"\n"}
            {"\n"}
            Kodepos{"\t"}
            {"\t"}
            {"\t"}35141{"\n"}
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.isi}>
            Jl. Mawar No.43, Kedaton, Kec. Kedaton, Kota Bandar Lampung, Lampung
            35132
          </Text>
          <Image
            source={require("../../../assets/image/alamat.png")}
            style={styles.gambaralamat}
          />
        </View>
      </View>
    </ScrollView>
